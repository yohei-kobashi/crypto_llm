...
#SBATCH --job-name=training_poly_00s_block_000
#SBATCH --output=run_training_poly_00s_block_000.out
...
model_num="1"
lang="en"
encryption="poly_00s_block_000"
output_model_dir="/storage9/encrypted_llm/models/${model_num}.${lang}_${encryption}/"
unique_id="${host}_${current_time}"
# bash ./gcp_honban_node-1_gpu-8/zero-0_dp-8_pp-1_tp-1_precision-bf16_flashattn2-on.sh \
#     --input_tokenizer_file /storage9/encrypted_llm/tokenizers/tokenizer-wikipedia-${lang}_${encryption}.model \
#     --output_model_dir ${output_model_dir} \
#     --save_interval 500 \
#     --wandb_entity yohei-kobashi \
#     --wandb_project encrypted_data_LLM \
#     --data_base_dir /storage9/encrypted_llm/datasets \
#     --train_data_file /storage9/encrypted_llm/datasets/encrypted/wikipedia_${lang}_${encryption}.jsonl \
