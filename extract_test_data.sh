...
python script/preprocess/parquet_sampler.py --input-dir fineweb-edu/sample/100BT-10BT --output-dir fineweb-edu/sample/100BT-10BT-sampled2 --sampling-rate 1/9 --num-procs 10
